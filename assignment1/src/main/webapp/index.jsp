...
<html>
    ...
    if(session.getAttribute("flightList") == null){
        ArrayList<Flight> flightList = new ArrayList<Flight>();
            ...
            Flight f1 = new Flight(101,"JetEngine",250,50,"JetEngine.jpg",t1,"Sydney","Melbourne", 2,"Non-Stop","Economy");
            Flight f2 = new Flight(102,"Harmony",630,50,"Harmony.jpg",t2,"Melbourne","Sydney",2,"Non stop","Business");
            Flight f3 = new Flight(103,"Traveling",500,50,"Travel.jpg",t3,"Queensland","Melbourne",2,"Non stop","Premium Economy");    
            flightList.add(f1);
            flightList.add(f2);
            flightList.add(f3);
